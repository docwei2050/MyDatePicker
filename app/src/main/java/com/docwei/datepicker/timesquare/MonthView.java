    ...
    for (int i = 0; i < 6; i++) {
      ...
      if (i < numRows) {
        ...
        for (int c = 0; c < week.size(); c++) {
          ...
          cellView.setStart(cell.isStart());
          cellView.setEnd(cell.isEnd());
          if(cellView.isStart()){
            cellView.getDayOfMonthTextView().setText(cellDate + "\n" + "开始");
          }
          if(cellView.isEnd()){
        ...
        weekRow.setVisibility(GONE);//牛逼了无需显示
      }
    }
